...
<head>
    ...
    <title>Floral Mandap Decoration Gallery</title>
    <style>
        body {
...
<header>
    <h1>Floral Mandap Decoration Gallery</h1>
    <p>Find the perfect floral decoration for your special occasion!</p>
</header>
...
<div class="gallery" id="gallery">
    ...
    // Fetching floral-themed mandap designs only
    $query = "SELECT id, design_name AS name, image_url AS image, description, theme, price FROM mandap_designs WHERE theme = 'floral'";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        echo "<p>No floral mandap designs found!</p>";
    }
    ?>
</div>
